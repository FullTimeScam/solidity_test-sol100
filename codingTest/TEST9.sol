...
contract TEST9 {
    ...
    function pwCheck(string memory _pw) public pure returns(bool) {
        ...
        require(number, "need contain at leat 1 number");
        require(upper, "need contain at leat 1 uppercase");
        require(lower, "need contain at leat 1 lowercase");
